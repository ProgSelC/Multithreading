...
public class Main {
	public static void main(String args[]) {
		...
		System.out.printf("Sorting Merge time with %d threads: %d ms\n",
				threads, runMergeMulti(arr3, threads));

		System.out.printf("Sorting Merge time with %d thread: %d ms\n", 1,
				runMergeMulti(arr4, 1));
		...
		System.out.println("Arrays.sort and merge-multi arrays are equal: " + Arrays.equals(arr3, myArr));
		System.out.println("Arrays.sort and merge-single arrays are equal: " + Arrays.equals(arr4, myArr));
	}
	...
	// --------------------------------------------------------------------------
	static long runMergeMulti(int[] a, int threads) {
		int pLen = a.length / threads;
		...
		for (int i = 0; i < threads; i++) {
			...
			thr[i] = new Thread(new ArrayThread(pSort[i]));
			thr[i].start();
